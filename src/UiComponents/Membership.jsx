        ...
        <section id='membership' class="text-gray-400 bg-black body-font overflow-hidden">
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="flex flex-wrap -m-4 justify-center">
                    ...
                    <div class="p-4 xl:w-1/4 md:w-1/2 w-full" data-aos='zoom-in'>
                        <div class="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col  overflow-hidden">
                            {/* <span class="bg-indigo-500 text-white px-3 py-1 tracking-widest text-xs  right-0 top-0 rounded-bl">POPULAR</span> */}
