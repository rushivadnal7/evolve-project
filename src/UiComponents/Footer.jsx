                    ...
                    <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <span onClick={navigate('/')} className="text-gray-400 hover:text-white">Home</span>
                                </li>
                                <li>
                                    <span onClick={navigate('/about')} className="text-gray-400 hover:text-white">About</span>
                                </li>
                                <li>
                                    <span onClick={navigate('/contact')} className="text-gray-400 hover:text-white">Contact</span>
                                </li>
