...
const StraightArm_calisthenic = () => {
  ...
  useEffect(() => {
    ...
    const fetchImages = async () => {
      const storageRef = StorageRef(firebaseStorage, '/Calisthenics/StraightArm')
  ...
  return (
    <>
      <section className="text-gray-400 bg-gray-900 h-screen overflow-y-auto ">
        <NavigationBar/>
...
export default StraightArm_calisthenic