      ...
      {/* <header class="text-gray-400 bg-gray-900 body-font w-full navbar">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
            <Link to={'/login'}>
              <button class="inline-flex items-center bg-gray-800  font-semibold py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0">Login
      ...
      <section class="text-gray-400 bg-gray-900 body-font relative">
        ...
        <div class="container px-5 py-24 mx-auto flex">
          <div class="lg:w-1/3 md:w-1/2 bg-gray-900 shadow-md rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
            ...
            <p class="leading-relaxed mb-5 fa">&#xf0e0; contactinfo@gmail.com</p>
            <p class="leading-relaxed mb-5 fa">	&#xf095; +91 2359465894</p>
