...
import bentArm from '../imgs/bent_arm.jpg'
import straightArm from '../imgs/straight_arm.jpg'
...
const Calisthenic = () => {
  ...
  const [exercises, setExercises] = useState([
    { image: bentArm, name: 'BentArm' },
    { image: straightArm, name: 'StraightArm' },
  ]);
        ...
        <div className='w-screen h-screen flex justify-center  bg-gray-700 items-center'>
          <div className='video-parent-box mx-12 my-20 '>
            {exercises.map((exercise, index) => (
              <Dialog key={index}>
                <DialogTrigger>
                  <Link to={`/${exercise.name.toLowerCase()}`}>
